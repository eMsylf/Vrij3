...
namespace Fungus
{
    ...
    public class DialogInput : MonoBehaviour
    {
...
#if ENABLE_INPUT_SYSTEM
        public void InputSystemSetup()
        {
            InputSystemUIInputModule inputModule = GetInputModule();
            if (inputModule != null)
            {
                inputModule.leftClick.action.performed += LeftClick;
                inputModule.submit.action.performed += SubmitOrCancel;
                inputModule.cancel.action.performed += SubmitOrCancel;
            }
        }
        ...
        private void SubmitOrCancel(InputAction.CallbackContext obj)
        {
        ...
        protected virtual bool CheckEventSystem()
        {
...
#if ENABLE_INPUT_SYSTEM
            // See Awake function for button setup
#else
