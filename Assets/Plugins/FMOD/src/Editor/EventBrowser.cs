...
namespace FMODUnity
{
    class EventBrowser : EditorWindow, ISerializationCallbackReceiver
    {
        ...
        private Action eventSetCallback;
        ...
        private void SetOutputProperty(ScriptableObject data)
        {
            ...
            if (eventSetCallback != null) {
                eventSetCallback.Invoke();
                eventSetCallback = null;
            }
        }
        ...
        public void ChooseEvent(SerializedProperty property, Action eventSetCallback = null)
        {
            BeginInspectorPopup(property, TypeFilter.Event);
            this.eventSetCallback = eventSetCallback;
        ...
        public void ChooseParameter(SerializedProperty property, Action eventSetCallback = null)
        {
