...
public class Direction : MonoBehaviour
{
    ...
    public ELookDirection UpdateLookDirection(Vector2 movement)
    {
        ...
        MovementIndicator.localPosition = new Vector3(movement.x, 0f, movement.y);
        ...
        {
            float distanceToDirection = Vector3.Distance(MovementIndicator.position, lookDirectionObj.transform.position);
